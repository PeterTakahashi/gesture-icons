...
/**
 * Tally 4 — it counts itself out loud. Each stroke erases then pen-redraws
 ...
 * Base geometry: Lucide `tally-4` (ISC).
 */
const DUR = 0.85
const STEP = 0.08
...
export function Tally4Icon({
  ...
  return (
    <svg
      ...
      className={className} style={style} role="img" aria-label={rest['aria-label'] ?? 'tally 4'}
      {...hoverProps}
    >
