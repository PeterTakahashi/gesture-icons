...
export function ZodiacAquariusIcon({
  ...
  return (
    <svg
      ...
      className={className} style={style} role="img" aria-label={rest['aria-label'] ?? 'zodiac aquarius'}
      {...hoverProps}
    >
      <motion.g
...
export const meta = {
  ...
  section: 'Interface',
  tags: ['zodiac', 'astrology', 'star', 'aquarius'],
}
