...
export function ZodiacCancerIcon({
  ...
  return (
    <svg
      ...
      className={className} style={style} role="img" aria-label={rest['aria-label'] ?? 'zodiac cancer'}
      {...hoverProps}
    >
      <motion.g
...
export const meta = {
  ...
  section: 'Interface',
  tags: ['zodiac', 'astrology', 'star', 'cancer'],
}
